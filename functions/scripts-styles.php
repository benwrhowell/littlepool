...
function bulmapress_scripts() {
	...
	wp_enqueue_script('jquery');
	wp_enqueue_script( 'bulmapress-vendor', get_template_directory_uri() . '/build/js/vendor.min.js?v=11', true);
	wp_enqueue_script( 'bulmapress-custom', get_template_directory_uri() . '/build/js/custom.min.js?v=11', true);
